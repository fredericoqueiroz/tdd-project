...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        inputbox.send_keys('Estudar teste funcionais')

        # Quando aperta enter, a página atualiza, e mostra a lista
        ...
        # A página atualiza novamante, e agora mostra ambos os itens na sua lista
